...
import { SOAPNote } from '../src/types/documentation-compliance';
...
async function runLargeDocumentStressTest() {
  ...
  const largeNote: SOAPNote = {
    subjective: { 
      ...
      priorLevelOfFunction: 'Sub-acute',
    ...
    assessment: { 
      ...
      progressTowardGoals: 'Steady',
      clinicalReasoning: massiveText.substring(0, 500) 
    },
    plan: { 
      interventions: ['Comprehensive rehab'], 
      frequency: 'Daily', 
      duration: '90 days',
      shortTermGoals: [],
      longTermGoals: [],
      patientEducation: 'Discussed safety.'
    }
  };
