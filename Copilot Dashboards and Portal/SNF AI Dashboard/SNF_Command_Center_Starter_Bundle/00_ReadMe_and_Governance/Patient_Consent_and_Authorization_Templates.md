# Patient Consent and Authorization Templates.pdf

## Purpose

- Starter source-controlled equivalent for the governed artifact named Patient_Consent_and_Authorization_Templates.pdf.
