# Patient Rights and Responsibilities Document.pdf

## Purpose

- Starter source-controlled equivalent for the governed artifact named Patient_Rights_and_Responsibilities_Document.pdf.
- Use this file as the editable design source before a controlled PDF or DOCX version is issued.

## Scope

- Folder: 02_Clinical_Workflows_and_Protocols
