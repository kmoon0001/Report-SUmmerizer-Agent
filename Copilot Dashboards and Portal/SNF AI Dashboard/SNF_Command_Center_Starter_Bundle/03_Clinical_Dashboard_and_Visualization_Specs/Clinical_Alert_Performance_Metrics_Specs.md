# Clinical Alert Performance Metrics Specs.md

## Purpose

- Starter source-controlled equivalent for the governed artifact named Clinical_Alert_Performance_Metrics_Specs.md.
