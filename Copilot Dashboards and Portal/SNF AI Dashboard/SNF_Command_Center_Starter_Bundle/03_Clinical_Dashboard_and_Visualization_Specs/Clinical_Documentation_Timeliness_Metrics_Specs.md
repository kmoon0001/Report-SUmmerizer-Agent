# Clinical Documentation Timeliness Metrics Specs.md

## Purpose

- Starter source-controlled equivalent for the governed artifact named Clinical_Documentation_Timeliness_Metrics_Specs.md.
