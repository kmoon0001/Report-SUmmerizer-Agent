...
$pythonPath = 'D:\SNF AI Dashboard\tmp\pdf-env\Scripts\python.exe'
$venvRoot = 'D:\SNF AI Dashboard\tmp\pdf-env'
...
$scriptPath = 'D:\SNF AI Dashboard\tmp\extract-nethealth-therapy-pdf.py'
