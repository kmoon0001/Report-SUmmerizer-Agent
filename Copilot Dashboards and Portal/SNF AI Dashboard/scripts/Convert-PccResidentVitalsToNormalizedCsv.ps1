param(
    [string]$InputPath = 'D:\SNF AI Dashboard\data\incoming\pcc_resident_vitals.csv',
    [string]$PccActiveCensusPath = 'D:\SNF AI Dashboard\data\processed\pcc_resident_list_current.active-only.csv',
    [string]$OutputPath = 'D:\SNF AI Dashboard\data\processed\pcc_resident_vitals_current.csv',
    [string]$QualityReportPath = 'D:\SNF AI Dashboard\data\processed\pcc_resident_vitals_current.quality-report.md'
)
