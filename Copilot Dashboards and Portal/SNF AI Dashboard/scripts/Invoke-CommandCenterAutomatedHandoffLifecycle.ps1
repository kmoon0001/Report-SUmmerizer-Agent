param(
    ...
    [string]$DispatchLogPath = 'D:\SNF AI Dashboard\data\processed\command_center_automated_handoff_dispatch_log.csv',
    [string]$ResolutionSignalsPath = 'D:\SNF AI Dashboard\data\processed\command_center_handoff_resolution_signals.csv',
    [string]$OutputPath = 'D:\SNF AI Dashboard\data\processed\command_center_automated_handoff_queue.csv',
    [string]$StatusSummaryPath = 'D:\SNF AI Dashboard\data\processed\command_center_automated_handoff_queue.by-status.csv',
    [string]$SummaryPath = 'D:\SNF AI Dashboard\data\processed\command_center_automated_handoff_lifecycle_summary.md'
)
