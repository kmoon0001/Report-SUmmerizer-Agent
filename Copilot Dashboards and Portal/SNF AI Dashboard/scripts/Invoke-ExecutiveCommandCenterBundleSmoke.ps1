param(
    [string]$PlaywrightRoot = 'D:\SNF AI Dashboard\playwright',
    [string]$BundleHtmlPath = 'D:\SNF AI Dashboard\data\exports\executive-command-center\current\executive-command-center.html'
)
