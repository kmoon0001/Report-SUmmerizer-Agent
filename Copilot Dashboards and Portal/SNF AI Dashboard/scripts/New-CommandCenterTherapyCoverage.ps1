param(
    [string]$ResolvedTherapyPath = 'D:\SNF AI Dashboard\data\processed\nethealth_therapy_census.resolved.csv',
    [string]$OutputPath = 'D:\SNF AI Dashboard\data\processed\command_center_therapy_coverage.csv',
    [string]$UnitSummaryPath = 'D:\SNF AI Dashboard\data\processed\command_center_therapy_coverage.by-unit.csv'
)
