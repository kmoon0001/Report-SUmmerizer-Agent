# Clinical Clinical Documentation Completeness Metrics Specs.md

## Purpose

- Starter source-controlled equivalent for the governed artifact named Clinical_Clinical_Documentation_Completeness_Metrics_Specs.md.
