# Clinical Nutritional Status Outcome Prediction Metrics Specs.md

## Purpose

- Starter source-controlled equivalent for the governed artifact named Clinical_Nutritional_Status_Outcome_Prediction_Metrics_Specs.md.
