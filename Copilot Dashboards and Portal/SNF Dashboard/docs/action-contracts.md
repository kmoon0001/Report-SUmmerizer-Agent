...
Action file:
- `actions/ExportCareSummary.mcs.yml`

Workflow folder:
- `workflows/SNF-Command-Center-ExportCareSummary-ae053d82-b043-4b7d-92bb-902dba031aa7`

Primary purpose:
- Return a secure-summary export response for family, discharge, ACP, or hospice coordination outputs.
