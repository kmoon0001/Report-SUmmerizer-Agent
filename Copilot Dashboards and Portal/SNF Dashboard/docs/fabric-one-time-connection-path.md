...
```powershell
powershell -ExecutionPolicy Bypass -File "D:\my agents copilot studio\SNF Dashboard\scripts\Invoke-FabricOneTimeConnectionPrep.ps1"
```
...
4. Try auto-recovery of IDs first:
   - `powershell -ExecutionPolicy Bypass -File "D:\my agents copilot studio\SNF Dashboard\scripts\Get-LocalFabricMetadata.ps1"`
