...
```powershell
powershell -ExecutionPolicy Bypass -File "D:\my agents copilot studio\SNF Dashboard\scripts\Convert-NetHealthTherapyCensusToNormalizedCsv.ps1" -InputPath "D:\my agents copilot studio\SNF Dashboard\data\incoming\nethealth_therapy_census.csv"
powershell -ExecutionPolicy Bypass -File "D:\my agents copilot studio\SNF Dashboard\scripts\Test-NetHealthTherapyCensusNormalizedCsv.ps1" -Path "D:\my agents copilot studio\SNF Dashboard\data\processed\nethealth_therapy_census.normalized.csv"
powershell -ExecutionPolicy Bypass -File "D:\my agents copilot studio\SNF Dashboard\scripts\Resolve-NetHealthTherapyResidentsAgainstPcc.ps1"
powershell -ExecutionPolicy Bypass -File "D:\my agents copilot studio\SNF Dashboard\scripts\New-CommandCenterTherapyCoverage.ps1"
```

## Expected Outputs

- `D:\my agents copilot studio\SNF Dashboard\data\processed\nethealth_therapy_census.normalized.csv`
- `D:\my agents copilot studio\SNF Dashboard\data\processed\nethealth_therapy_census.resolved.csv`
- `D:\my agents copilot studio\SNF Dashboard\data\processed\command_center_therapy_coverage.csv`
- `D:\my agents copilot studio\SNF Dashboard\data\processed\command_center_therapy_coverage.by-unit.csv`
