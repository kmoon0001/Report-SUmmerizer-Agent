...
$tempExtractedCsv = 'D:\my agents copilot studio\SNF Dashboard\tmp\nethealth_therapy_census.extracted.csv'
...
if ($headerText -eq '%PDF-') {
    & 'D:\my agents copilot studio\SNF Dashboard\scripts\Convert-NetHealthTherapyPdfToCsv.ps1' -InputPath $InputPath -OutputPath $tempExtractedCsv
