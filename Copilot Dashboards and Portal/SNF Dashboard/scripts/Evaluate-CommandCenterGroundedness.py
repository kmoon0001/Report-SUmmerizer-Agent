...
def main() -> int:
    ...
    try:
        ...
        return write_skip("azure-ai-evaluation is not installed.")
    ...
    if missing:
        return write_skip(
            f"Azure OpenAI groundedness configuration is incomplete: {', '.join(missing)}"
        )
