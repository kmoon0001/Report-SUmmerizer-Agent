param(
    [string]$EnvFile = 'D:\my agents copilot studio\SNF Dashboard\.env',
    [string]$OutputPath = 'D:\my agents copilot studio\SNF Dashboard\data\processed\fabric_one_time_connection_prep.md'
)
...
$lines += ''
$lines += '1. Run: `powershell -ExecutionPolicy Bypass -File "D:\my agents copilot studio\SNF Dashboard\scripts\Invoke-PowerBiExecutivePrep.ps1"`'
