param(
    ...
    [string]$CsvOutputPath = 'D:\my agents copilot studio\SNF Dashboard\data\processed\command_center_operational_history.csv',
    [string]$JsonOutputPath = 'D:\my agents copilot studio\SNF Dashboard\data\processed\command_center_operational_history.json'
)
