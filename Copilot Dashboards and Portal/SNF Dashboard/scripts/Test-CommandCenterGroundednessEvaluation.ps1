param(
    ...
    [string]$DatasetPath = 'D:\my agents copilot studio\SNF Dashboard\data\processed\command_center_groundedness_eval_dataset.jsonl',
    [string]$ResultPath = 'D:\my agents copilot studio\SNF Dashboard\data\processed\command_center_groundedness_eval.json',
    [string]$ReportPath = 'D:\my agents copilot studio\SNF Dashboard\data\processed\command_center_groundedness_eval.md',
