...
The following external sources are the primary "Sources of Truth" for the Pac Coast Report Prep Agent. Use these for web-search grounding and clinical justification.
