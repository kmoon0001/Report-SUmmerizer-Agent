# Clinical Delirium Prediction Model Specs.md

## Purpose

- Starter source-controlled equivalent for the governed artifact named Clinical_Delirium_Prediction_Model_Specs.md.
