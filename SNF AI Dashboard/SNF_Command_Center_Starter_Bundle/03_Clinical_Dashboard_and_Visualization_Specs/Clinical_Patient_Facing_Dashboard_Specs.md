# Clinical Patient Facing Dashboard Specs.md

## Purpose

- Starter source-controlled equivalent for the governed artifact named Clinical_Patient_Facing_Dashboard_Specs.md.
