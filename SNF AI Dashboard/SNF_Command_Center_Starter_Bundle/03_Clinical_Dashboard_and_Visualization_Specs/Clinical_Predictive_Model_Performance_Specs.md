# Clinical Predictive Model Performance Specs.md

## Purpose

- Starter source-controlled equivalent for the governed artifact named Clinical_Predictive_Model_Performance_Specs.md.
