# Clinical Pressure Injury Prediction Model Specs.md

## Purpose

- Starter source-controlled equivalent for the governed artifact named Clinical_Pressure_Injury_Prediction_Model_Specs.md.
