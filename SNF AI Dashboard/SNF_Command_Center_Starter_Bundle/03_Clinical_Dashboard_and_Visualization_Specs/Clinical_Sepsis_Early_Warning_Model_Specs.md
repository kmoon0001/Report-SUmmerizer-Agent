# Clinical Sepsis Early Warning Model Specs.md

## Purpose

- Starter source-controlled equivalent for the governed artifact named Clinical_Sepsis_Early_Warning_Model_Specs.md.
