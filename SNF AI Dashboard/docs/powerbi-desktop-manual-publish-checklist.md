...
1. Run:
   - `powershell -ExecutionPolicy Bypass -File "D:\SNF AI Dashboard\scripts\Invoke-PowerBiExecutivePrep.ps1"`
   - `powershell -ExecutionPolicy Bypass -File "D:\SNF AI Dashboard\scripts\Invoke-PowerBiManualAssistPrep.ps1"`
...
3. Import all CSVs from:
   - `D:\SNF AI Dashboard\integrations\powerbi\source-package\current\model-tables`
4. Apply theme:
...
2. Run Playwright smoke:
   - `powershell -ExecutionPolicy Bypass -File "D:\SNF AI Dashboard\scripts\Invoke-PowerBiPublishedSmoke.ps1"`
