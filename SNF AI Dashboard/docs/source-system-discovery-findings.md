...
- Cloned solution source for `PCCAv2` into:
  - [tmp/PCCAv2-solution](D:\SNF AI Dashboard\tmp\PCCAv2-solution)
...
Evidence:
- [Customizations.xml](D:\SNF AI Dashboard\tmp\PCCAv2-solution\PCCAv2\src\Other\Customizations.xml) has:
  - `<Entities />`
