param(
    ...
    [string]$OutputMarkdownPath = 'D:\SNF AI Dashboard\data\processed\autonomous_failure_triage.md',
    [string]$OutputJsonPath = 'D:\SNF AI Dashboard\data\processed\autonomous_failure_triage.json'
)
