param(
    ...
    [string]$OutputPath = 'D:\SNF AI Dashboard\data\processed\command_center_shap_explanations.csv',
    [string]$FeatureImportancePath = 'D:\SNF AI Dashboard\data\processed\command_center_shap_feature_importance.csv',
    [string]$SummaryPath = 'D:\SNF AI Dashboard\data\processed\command_center_shap_summary.md',
    [string]$PythonPath = 'D:\SNF AI Dashboard\.venv-codex-yaml\Scripts\python.exe',
...
$scriptPath = 'D:\SNF AI Dashboard\scripts\Build-CommandCenterShapExplanations.py'
