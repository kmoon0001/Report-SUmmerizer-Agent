...
- run `Invoke-CopilotEndToEnd.ps1` when you want one-command Copilot delivery gates (validate, preflight, authoring checks, resilient apply, publish, and status verification) with a persisted report
