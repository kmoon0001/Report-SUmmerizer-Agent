# Infection Control Policy and Procedure Manual.pdf

## Purpose

- Starter source-controlled equivalent for the governed artifact named Infection_Control_Policy_and_Procedure_Manual.pdf.
