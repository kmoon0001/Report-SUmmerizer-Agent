# Patient Transfer and Mobility Assessment Protocols.pdf

## Purpose

- Starter source-controlled equivalent for the governed artifact named Patient_Transfer_and_Mobility_Assessment_Protocols.pdf.
- Use this file as the editable design source before a controlled PDF or DOCX version is issued.

## Scope

- Folder: 01_Clinical_Assistant_Specs
