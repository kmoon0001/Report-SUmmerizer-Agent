# Infection Control Outbreak Response Protocol.pdf

## Purpose

- Starter source-controlled equivalent for the governed artifact named Infection_Control_Outbreak_Response_Protocol.pdf.
