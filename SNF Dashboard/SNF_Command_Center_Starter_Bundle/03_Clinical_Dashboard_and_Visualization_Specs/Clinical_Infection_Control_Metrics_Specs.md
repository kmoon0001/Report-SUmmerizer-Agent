# Clinical Infection Control Metrics Specs.md

## Purpose

- Starter source-controlled equivalent for the governed artifact named Clinical_Infection_Control_Metrics_Specs.md.
