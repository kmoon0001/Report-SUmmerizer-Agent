# Clinical Medication Adherence Metrics Specs.md

## Purpose

- Starter source-controlled equivalent for the governed artifact named Clinical_Medication_Adherence_Metrics_Specs.md.
