# Clinical Mobility And Function Outcome Prediction Metrics Specs.md

## Purpose

- Starter source-controlled equivalent for the governed artifact named Clinical_Mobility_And_Function_Outcome_Prediction_Metrics_Specs.md.
