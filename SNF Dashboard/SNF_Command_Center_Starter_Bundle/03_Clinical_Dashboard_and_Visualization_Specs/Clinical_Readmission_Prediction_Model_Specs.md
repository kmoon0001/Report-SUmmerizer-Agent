# Clinical Readmission Prediction Model Specs.md

## Purpose

- Starter source-controlled equivalent for the governed artifact named Clinical_Readmission_Prediction_Model_Specs.md.
