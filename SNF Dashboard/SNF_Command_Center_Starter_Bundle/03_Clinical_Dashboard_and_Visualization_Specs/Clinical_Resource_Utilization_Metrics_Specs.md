# Clinical Resource Utilization Metrics Specs.md

## Purpose

- Starter source-controlled equivalent for the governed artifact named Clinical_Resource_Utilization_Metrics_Specs.md.
