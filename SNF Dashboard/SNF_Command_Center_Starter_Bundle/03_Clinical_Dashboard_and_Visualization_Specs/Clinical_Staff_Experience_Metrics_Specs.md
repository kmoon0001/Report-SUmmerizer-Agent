# Clinical Staff Experience Metrics Specs.md

## Purpose

- Starter source-controlled equivalent for the governed artifact named Clinical_Staff_Experience_Metrics_Specs.md.
