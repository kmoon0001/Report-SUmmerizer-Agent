# Clinical Staff Satisfaction Metrics Specs.md

## Purpose

- Starter source-controlled equivalent for the governed artifact named Clinical_Staff_Satisfaction_Metrics_Specs.md.
