param(
    ...
    [string]$SourceMcpPath = 'D:\my agents copilot studio\SNF Dashboard\.vscode\mcp.json',
    [string]$OutputRoot = 'D:\my agents copilot studio\SNF Dashboard\data\exports\mcp-profiles\current',
