param(
    ...
    [string]$OutputPath = 'D:\my agents copilot studio\SNF Dashboard\data\processed\pcc_visible_report_names.txt',
    [int]$WaitSeconds = 90
)
...
$playwrightRoot = 'D:\my agents copilot studio\SNF Dashboard\playwright'
