param(
    ...
    [string]$VitalsPath = 'D:\my agents copilot studio\SNF Dashboard\data\processed\pcc_resident_vitals_current.csv',
    [string]$ScoringConfigPath = 'D:\my agents copilot studio\SNF Dashboard\contracts\patient-insight-scoring.json',
    [string]$OutputPath = 'D:\my agents copilot studio\SNF Dashboard\data\processed\command_center_patient_insights.csv'
)
