param(
    ...
    [string]$ThresholdsPath = 'D:\my agents copilot studio\SNF Dashboard\contracts\command-center-data-drift-thresholds.json',
    [string]$OutputPath = 'D:\my agents copilot studio\SNF Dashboard\data\processed\command_center_data_drift_report.md'
)
