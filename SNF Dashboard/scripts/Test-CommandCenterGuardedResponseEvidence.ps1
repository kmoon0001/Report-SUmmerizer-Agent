...
if ([string]::IsNullOrWhiteSpace($Path)) {
    $Path = Join-Path $projectRoot 'data\processed\command_center_automated_handoff_queue.csv'
}
if ([string]::IsNullOrWhiteSpace($ContractPath)) {
    $ContractPath = Join-Path $projectRoot 'contracts\guarded-response-contract.json'
}
