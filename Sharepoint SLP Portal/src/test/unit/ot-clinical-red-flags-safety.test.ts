/**
 * OT Clinical Red Flags & Safety Screening Tests
 */
...
import {
  ...
  assessSafetyRisk,
} from "../../data/ot-clinical-red-flags-safety";

describe("OT Clinical Red Flags & Safety Screening", () => {
  it("should have 5 safety screenings", () => {
    expect(getAllSafetyScreenings().length).toBe(5);
  });

  it("should return screening by ID", () => {
    const screening = getSafetyScreeningById("ot-sf-001");
    expect(screening?.condition).toContain("Cognitive");
  });
  ...
  it("should filter by category", () => {
    const screenings = getSafetyScreeningsByCategory("Neurological");
  ...
  it("should get red flags by category", () => {
    const flags = getRedFlagsByCategory("Cognitive");
  ...
  it("should assess safety risk", () => {
    const assessment = assessSafetyRisk("ot-sf-001", [
  ...
  it("should assess low risk correctly", () => {
    const assessment = assessSafetyRisk("ot-sf-001", ["No symptoms"]);
